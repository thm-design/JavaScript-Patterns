...
(function() {
  ...
  Modal.prototype.close = function() {
    var _ = this;
    this.modal.className = this.modal.className.replace(" moda-open", "");
    this.overlay.className = this.overlay.className.replace(" moda-open",
      "");
  ...
  Modal.prototype.open = function() {
    ...
    this.modal.className = this.modal.className +
      (this.modal.offsetHeight > window.innerHeight ?
        " moda-open moda-anchored" : " moda-open");
    this.overlay.className = this.overlay.className + " moda-open";
  }
  ...
  function buildOut() {
    ...
    this.modal.className = "moda-modal " + this.options.className;
    ...
    if (this.options.closeButton === true) {
      ...
      this.closeButton.className = "moda-close close-button";
    ...
    if (this.options.overlay === true) {
      ...
      this.overlay.className = "moda-overlay " + this.options.className;
      docFrag.appendChild(this.overlay);
    }

    // Create content area and append to modal
    contentHolder = document.createElement("div");
    contentHolder.className = "moda-content";
